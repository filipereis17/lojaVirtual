...
As principais linguagens e ferramentas encontradas e incluídas no Yii 2 são: HTML5, CSS3, PHP, JavaScript, BootStrap 4, jQuery.
...
Escolha 0 [Development] e confirme "yes".
